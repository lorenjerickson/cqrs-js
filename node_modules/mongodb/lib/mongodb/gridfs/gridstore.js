 ...
 *
 * Events
 *  - **data** {function(item) {}} the data eventstore triggers when a document is ready.
 *  - **end** {function() {}} the end eventstore triggers when there is no more documents available.
 *  - **close** {function() {}} the close eventstore triggers when the stream is closed.
 *  - **error** {function(err) {}} the error eventstore triggers if an error happens.
 *
 * @param {Boolean} autoclose if true current GridStore will be closed when EOF and 'close' eventstore will be fired
 * @return {null}
 * @api public
 */
