...
var CallbackStore = function() {
  // Make class an eventstore emitter
...
/**
 * Close the current db connection, including all the child db instances. Emits close eventstore if no callback is provided.
 *
...
Db.prototype.close = function(forceClose, callback) {  
  ...
  this.serverConfig.close(function(err, result) {
    // Emit the close eventstore
    if(typeof callback !== 'function') self.emit("close");

    // Emit close eventstore across all db instances sharing the sockets
